...
?>	
	<form method="POST">
	<input name="Addnew" class="btn btn-primary" type="submit" value="Add New Student"/>
	<input name="Addold" class="btn btn-primary" type="submit" value="Add Old Student"/><br><br>
	</form>
